...
namespace Refrence {
	...
	std::string descriptions[GAME_WITDH * GAME_HEIGHT] = {
		...
		"Common room. There is a warm fire in here, but there are also some very intimidating paintings.", "Entrance Hallway. Large banners of some unknown faction hang from the hallway", "Kitchen. There are by products and utensils still out from the making of the last meal but still no people..."

	};
	
	// UP, LEFT, RIGHT, DOWN
	bool roomDoors[GAME_HEIGHT * GAME_WITDH][4] = {
